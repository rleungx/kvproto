...
type GetServiceEndpointRequest struct {
	ServiceName          string   `protobuf:"bytes,1,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty"`
	KeyspaceGroupName    string   `protobuf:"bytes,2,opt,name=keyspace_group_name,json=keyspaceGroupName,proto3" json:"keyspace_group_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetServiceEndpointRequest) GetKeyspaceGroupName() string {
	if m != nil {
		return m.KeyspaceGroupName
	}
	return ""
}
...
func (m *GetAllServiceEndpointsRequest) GetKeyspaceGroupName() string {
	if m != nil {
		return m.KeyspaceGroupName
	}
	return ""
...
var fileDescriptor_1e7ff60feb39c8d0 = []byte{
	...
	,
}
...
func (m *GetServiceEndpointRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.KeyspaceGroupName) > 0 {
		i -= len(m.KeyspaceGroupName)
		copy(dAtA[i:], m.KeyspaceGroupName)
		i = encodeVarintDiscovery(dAtA, i, uint64(len(m.KeyspaceGroupName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ServiceName) > 0 {
...
func (m *GetServiceEndpointRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KeyspaceGroupName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KeyspaceGroupName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDiscovery(dAtA[iNdEx:])
