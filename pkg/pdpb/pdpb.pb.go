...
func (m *SyncMetaRequest) GetHeader() *RequestHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *SyncMetaRequest) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *SyncMetaRequest) GetKind() string {
	if m != nil {
		return m.Kind
	}
	return ""
...
func (m *SyncMetaRequest) GetStartIndex() uint64 {
	if m != nil {
		return m.StartIndex
	}
	return 0
...
type SyncMetaResponse struct {
	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	// the leader PD will send the responds include
	// changed records and the index of the first record.
	Objects              []*Object `protobuf:"bytes,2,rep,name=objects,proto3" json:"objects,omitempty"`
	StartIndex           uint64    `protobuf:"varint,3,opt,name=start_index,json=startIndex,proto3" json:"start_index,omitempty"`
	EventType            EventType `protobuf:"varint,4,opt,name=event_type,json=eventType,proto3,enum=pdpb.EventType" json:"event_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}

func (m *SyncMetaResponse) Reset()         { *m = SyncMetaResponse{} }
func (m *SyncMetaResponse) String() string { return proto.CompactTextString(m) }
...
func (m *SyncMetaResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SyncMetaResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SyncMetaResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SyncMetaResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SyncMetaResponse.Merge(m, src)
}
func (m *SyncMetaResponse) XXX_Size() int {
	return m.Size()
}
func (m *SyncMetaResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SyncMetaResponse.DiscardUnknown(m)
}

var xxx_messageInfo_SyncMetaResponse proto.InternalMessageInfo

func (m *SyncMetaResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *SyncMetaResponse) GetObjects() []*Object {
	if m != nil {
		return m.Objects
	}
	return nil
...
func (m *SyncMetaResponse) GetStartIndex() uint64 {
	if m != nil {
		return m.StartIndex
	}
	return 0
...
func (m *SyncMetaResponse) GetEventType() EventType {
	if m != nil {
		return m.EventType
	}
	return EventType_PUT
...
func (m *RegionInfo) GetRegion() *metapb.Region {
	if m != nil {
		return m.Region
	}
	return nil
...
func (m *RegionInfo) GetRegionStats() *RegionStat {
	if m != nil {
		return m.RegionStats
	}
	return nil
...
func (m *RegionInfo) GetLeader() *metapb.Peer {
	if m != nil {
		return m.Leader
	}
	return nil
...
func (m *RegionInfo) GetBuckets() *metapb.Buckets {
	if m != nil {
		return m.Buckets
	}
	return nil
...
type StoreInfo struct {
	Store                *metapb.Store `protobuf:"bytes,1,opt,name=store,proto3" json:"store,omitempty"`
	Stats                *StoreStats   `protobuf:"bytes,2,opt,name=stats,proto3" json:"stats,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
...
func (m *StoreInfo) GetStore() *metapb.Store {
	if m != nil {
		return m.Store
	}
	return nil
...
func (m *StoreInfo) GetStats() *StoreStats {
	if m != nil {
		return m.Stats
	}
	return nil
...
type Object_Region struct {
	Region *metapb.Region `protobuf:"bytes,1,opt,name=region,proto3,oneof" json:"region,omitempty"`
}
type Object_Store struct {
	Store *metapb.Store `protobuf:"bytes,2,opt,name=store,proto3,oneof" json:"store,omitempty"`
}
type Object_RegionInfo struct {
	RegionInfo *RegionInfo `protobuf:"bytes,3,opt,name=region_info,json=regionInfo,proto3,oneof" json:"region_info,omitempty"`
}
type Object_StoreInfo struct {
	StoreInfo *StoreInfo `protobuf:"bytes,4,opt,name=store_info,json=storeInfo,proto3,oneof" json:"store_info,omitempty"`
}

func (*Object_Region) isObject_Kind()     {}
func (*Object_Store) isObject_Kind()      {}
func (*Object_RegionInfo) isObject_Kind() {}
func (*Object_StoreInfo) isObject_Kind()  {}
...
func (m *Object) GetRegion() *metapb.Region {
	if x, ok := m.GetKind().(*Object_Region); ok {
		return x.Region
	}
	return nil
}

func (m *Object) GetStore() *metapb.Store {
	if x, ok := m.GetKind().(*Object_Store); ok {
		return x.Store
	}
	return nil
}

func (m *Object) GetRegionInfo() *RegionInfo {
	if x, ok := m.GetKind().(*Object_RegionInfo); ok {
		return x.RegionInfo
	}
	return nil
}

func (m *Object) GetStoreInfo() *StoreInfo {
	if x, ok := m.GetKind().(*Object_StoreInfo); ok {
		return x.StoreInfo
	}
	return nil
}
...
func (*Object) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Object_Region)(nil),
		(*Object_Store)(nil),
		(*Object_RegionInfo)(nil),
		(*Object_StoreInfo)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*SyncMetaRequest)(nil), "pdpb.SyncMetaRequest")
	proto.RegisterType((*SyncMetaResponse)(nil), "pdpb.SyncMetaResponse")
	proto.RegisterType((*RegionInfo)(nil), "pdpb.RegionInfo")
	proto.RegisterType((*StoreInfo)(nil), "pdpb.StoreInfo")
	proto.RegisterType((*Object)(nil), "pdpb.Object")
}
...
var fileDescriptor_78b27e6f04f44c6e = []byte{
	...
	,
}
...
type PDClient interface {
	...
	SyncMeta(ctx context.Context, opts ...grpc.CallOption) (PD_SyncMetaClient, error)
}
...
func (c *pDClient) SyncMeta(ctx context.Context, opts ...grpc.CallOption) (PD_SyncMetaClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PD_serviceDesc.Streams[6], "/pdpb.PD/SyncMeta", opts...)
	if err != nil {
		return nil, err
	}
	x := &pDSyncMetaClient{stream}
	return x, nil
}

type PD_SyncMetaClient interface {
	Send(*SyncMetaRequest) error
	Recv() (*SyncMetaResponse, error)
	grpc.ClientStream
}

type pDSyncMetaClient struct {
	grpc.ClientStream
}

func (x *pDSyncMetaClient) Send(m *SyncMetaRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *pDSyncMetaClient) Recv() (*SyncMetaResponse, error) {
	m := new(SyncMetaResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type PDServer interface {
	...
	SyncMeta(PD_SyncMetaServer) error
}
...
func (*UnimplementedPDServer) SyncMeta(srv PD_SyncMetaServer) error {
	return status.Errorf(codes.Unimplemented, "method SyncMeta not implemented")
}
...
func _PD_SyncMeta_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PDServer).SyncMeta(&pDSyncMetaServer{stream})
}

type PD_SyncMetaServer interface {
	Send(*SyncMetaResponse) error
	Recv() (*SyncMetaRequest, error)
	grpc.ServerStream
}

type pDSyncMetaServer struct {
	grpc.ServerStream
}

func (x *pDSyncMetaServer) Send(m *SyncMetaResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *pDSyncMetaServer) Recv() (*SyncMetaRequest, error) {
	m := new(SyncMetaRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (m *SyncMetaRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SyncMetaRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SyncMetaRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Address) > 0 {
		...
		i = encodeVarintPdpb(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0x12
	}
	if m.Header != nil {
...
func (m *SyncMetaResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SyncMetaResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SyncMetaResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Object_Region) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Object_Region) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Region != nil {
		{
			size, err := m.Region.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Object_Store) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Object_Store) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Store != nil {
		{
			size, err := m.Store.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Object_RegionInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Object_RegionInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.RegionInfo != nil {
		{
			size, err := m.RegionInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Object_StoreInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Object_StoreInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.StoreInfo != nil {
		{
...
func (m *SyncMetaRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SyncMetaResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Object_Region) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Object_Store) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Object_RegionInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Object_StoreInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SyncMetaRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SyncMetaRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SyncMetaRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SyncMetaResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SyncMetaResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SyncMetaResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Object) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Kind = &Object_Store{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RegionInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
