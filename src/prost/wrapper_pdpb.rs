...
impl GetRegionResponse {
    ...
    #[inline]
    pub fn set_secondaries(&mut self, v: ::std::vec::Vec<super::metapb::Peer>) {
        self.secondaries = v;
    }
    #[inline]
    pub fn get_secondaries(&self) -> &::std::vec::Vec<super::metapb::Peer> {
        &self.secondaries
    }
    #[inline]
    pub fn mut_secondaries(&mut self) -> &mut ::std::vec::Vec<super::metapb::Peer> {
        &mut self.secondaries
    }
    #[inline]
    pub fn take_secondaries(&mut self) -> ::std::vec::Vec<super::metapb::Peer> {
        ::std::mem::replace(&mut self.secondaries, ::std::vec::Vec::new())
    }
}
